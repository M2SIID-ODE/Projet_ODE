...
-- PATH vers le répertoire contenant les fichiers de chargement des données de votre SQL SERVER 2014
:setvar DonneesPath "C:\CONDUITE PROJET PAIE DOCKERS\MIAGE 2\BORDEAU\"
...
--FROM 'C:\CONDUITE PROJET PAIE DOCKERS\MIAGE 2\BORDEAU\Script_villes_france.csv'
FROM N'$(DonneesPath)Script_villes_france.csv'
WITH (
    --CHECK_CONSTRAINTS,
    --CODEPAGE='ACP',
    --DATAFILETYPE='char',
